#!/bin/bash
#
# Example script for MavenRSS - Shell RSS Feed Generator
#
...
<rss version="2.0">
  <channel>
    ...
    <link>https://github.com/WCY-dt/MavenRSS</link>
    <description>An example feed generated by a shell script</description>
    <lastBuildDate>${CURRENT_DATE}</lastBuildDate>
    <item>
      <title>Welcome to MavenRSS Custom Scripts</title>
      <link>https://github.com/WCY-dt/MavenRSS</link>
    ...
    <item>
      ...
      <link>https://github.com/WCY-dt/MavenRSS/blob/main/docs/CUSTOM_SCRIPTS.md</link>
