...
func TestUnreadCounts(t *testing.T) {
	...
	totalCount, err := db.GetTotalUnreadCount(0)
	if err != nil {
	...
	feedCount, err := db.GetUnreadCountByFeed(feedID, 0)
	if err != nil {
	...
	feedCounts, err := db.GetUnreadCountsForAllFeeds(0)
	if err != nil {
...
func TestMarkAllAsRead(t *testing.T) {
	...
	totalCount, _ := db.GetTotalUnreadCount(0)
	if totalCount != 0 {
...
func TestUnreadCountsWithHiddenArticles(t *testing.T) {
	...
	feedCount, _ := db.GetUnreadCountByFeed(feedID, 0)
	if feedCount != 1 {
