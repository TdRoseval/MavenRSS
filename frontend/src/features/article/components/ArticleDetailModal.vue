...
import ImageViewer from '@/shared/ui/ImageViewer.vue';
import FindInPage from '@/shared/ui/FindInPage.vue';
...
const currentArticleIndex = computed(() => {
  ...
  return articleStore.articles.findIndex((a) => a.id === props.article.id);
});
