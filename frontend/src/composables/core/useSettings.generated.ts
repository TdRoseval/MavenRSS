...
export function generateInitialSettings(): SettingsData {
  return {
    ...
    ai_embedding_models: settingsDefaults.ai_embedding_models,
    ...
    performance_mode: settingsDefaults.performance_mode,
...
export function parseSettingsData(data: Record<string, string>): SettingsData {
  return {
    ...
    ai_embedding_models: data.ai_embedding_models || settingsDefaults.ai_embedding_models,
    ...
    performance_mode: data.performance_mode || settingsDefaults.performance_mode,
...
export function buildAutoSavePayload(settingsRef: Ref<SettingsData>): Record<string, string> {
  return {
    ...
    ai_embedding_models:
      settingsRef.value.ai_embedding_models ?? settingsDefaults.ai_embedding_models,
    ai_endpoint: settingsRef.value.ai_endpoint ?? settingsDefaults.ai_endpoint,
    ai_enhanced_mode: (
      settingsRef.value.ai_enhanced_mode ?? settingsDefaults.ai_enhanced_mode
    ).toString(),
    ...
    performance_mode: settingsRef.value.performance_mode ?? settingsDefaults.performance_mode,
