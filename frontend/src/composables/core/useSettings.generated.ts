...
export function generateInitialSettings(): SettingsData {
  return {
    ...
    ai_fusion_enabled: settingsDefaults.ai_fusion_enabled,
...
export function parseSettingsData(data: Record<string, string>): SettingsData {
  return {
    ...
    ai_fusion_enabled: data.ai_fusion_enabled === 'true',
    ...
    ai_recommendation_profile_id: data.ai_recommendation_profile_id || settingsDefaults.ai_recommendation_profile_id,
    ...
    idle_conn_timeout_seconds: parseInt(data.idle_conn_timeout_seconds) || settingsDefaults.idle_conn_timeout_seconds,
    ...
    max_idle_conns_per_host: parseInt(data.max_idle_conns_per_host) || settingsDefaults.max_idle_conns_per_host,
...
export function buildAutoSavePayload(settingsRef: Ref<SettingsData>): Record<string, string> {
  return {
    ...
    ai_embedding_models: settingsRef.value.ai_embedding_models ?? settingsDefaults.ai_embedding_models,
    ai_endpoint: settingsRef.value.ai_endpoint ?? settingsDefaults.ai_endpoint,
    ai_enhanced_mode: (settingsRef.value.ai_enhanced_mode ?? settingsDefaults.ai_enhanced_mode).toString(),
    ai_fusion_enabled: (settingsRef.value.ai_fusion_enabled ?? settingsDefaults.ai_fusion_enabled).toString(),
    ai_fusion_profile_id: settingsRef.value.ai_fusion_profile_id ?? settingsDefaults.ai_fusion_profile_id,
    ai_model: settingsRef.value.ai_model ?? settingsDefaults.ai_model,
    ai_recommendation_enabled: (settingsRef.value.ai_recommendation_enabled ?? settingsDefaults.ai_recommendation_enabled).toString(),
    ai_recommendation_profile_id: settingsRef.value.ai_recommendation_profile_id ?? settingsDefaults.ai_recommendation_profile_id,
    ...
    ai_usage_hard_limit: settingsRef.value.ai_usage_hard_limit ?? settingsDefaults.ai_usage_hard_limit,
    ...
    idle_conn_timeout_seconds: (settingsRef.value.idle_conn_timeout_seconds ?? settingsDefaults.idle_conn_timeout_seconds).toString(),
    ...
    max_conns_per_host: (settingsRef.value.max_conns_per_host ?? settingsDefaults.max_conns_per_host).toString(),
    max_idle_conns: (settingsRef.value.max_idle_conns ?? settingsDefaults.max_idle_conns).toString(),
    max_idle_conns_per_host: (settingsRef.value.max_idle_conns_per_host ?? settingsDefaults.max_idle_conns_per_host).toString(),
