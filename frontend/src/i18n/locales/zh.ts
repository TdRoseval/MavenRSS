...
const zh: TranslationMessages = {
  article: {
    ...
    cluster: {
      ...
      authorLabel: '作者',
      dailyRecommendationCount: '{count} 条推荐',
      dailyRecommendationEmptyDescription:
        '当前日期还没有生成每日推荐，稍后可尝试刷新或切换其他日期。',
      dailyRecommendationEmptyTitle: '暂无每日推荐',
      dailyRecommendationLoadFailed: '加载每日推荐失败',
      dailyRecommendationLoadFailedTitle: '每日推荐加载失败',
      dailyRecommendationRefreshStarted: '已开始重新生成每日推荐',
      dailyRecommendationRefreshed: '每日推荐已刷新',
      dailyRecommendationTaskAutomaticDescription:
        '自动每日推荐任务正在后台运行，新的 Top 10 生成后这里会自动更新。',
      dailyRecommendationTaskCandidates: '候选数',
      dailyRecommendationTaskDate: '目标日期',
      dailyRecommendationTaskLabel: '推荐任务',
      dailyRecommendationTaskManualDescription:
        '正在根据最新的用户兴趣向量重新生成每日推荐，这次会强制重算。',
      dailyRecommendationTaskSaved: '已写入',
      dailyRecommendationTaskScoring: '评分中',
      dailyRecommendationTaskSelected: '入围数',
      dailyRecommendationTaskStage: '当前阶段',
      dailyRecommendationTaskStageFailed: '刷新失败',
      dailyRecommendationTaskStagePreparing: '准备任务',
      dailyRecommendationTaskStageQueued: '已进入队列',
      dailyRecommendationTaskStageRanking: '候选排序中',
      dailyRecommendationTaskStageRecalling: '召回候选中',
      dailyRecommendationTaskStageSaving: '写入推荐中',
      dailyRecommendationTaskStageScoring: '候选评分中',
      dailyRecommendationTaskStageWaiting: '等待后台任务空闲',
      dailyRecommendationTaskTitle: '每日推荐正在重新生成',
      dailyRecommendationTaskTrigger: '触发方式',
      dailyRecommendationTaskTriggerAutomatic: '自动补算',
      dailyRecommendationTaskTriggerManual: '手动刷新',
      dailyRecommendationTaskWaitingDescription:
        '当前刷新请求已经排队，会在后台 AI 任务空闲后自动开始。',
      dailyRecommendationTaskWaitingHint:
        '推荐刷新正在等待摘要、翻译、向量或聚类任务先完成。',
      dailyRecommendationTitle: 'AI 每日推荐',
      emptyDescription: 'AI 融合处理后的文章簇会自动汇总显示在这里。',
      emptyTitle: '暂无文章簇',
      listTitle: 'AI 融合文章簇',
      loadingDetail: '正在加载融合详情...',
      loadingMore: '正在加载更多...',
      markAllReadConfirm: '确定要将当前文章簇列表全部标记为已读吗？',
      markAllReadTitle: '全部标记为已读',
      markAllRecommendationsReadConfirm: '确定要将当前每日推荐中的全部文章簇标记为已读吗？',
      markAllRecommendationsReadTitle: '全部推荐标记为已读',
      markedAllAsRead: '已将全部文章簇标记为已读',
      markedAllRecommendationsAsRead: '已将全部推荐标记为已读',
      mergedFrom: '由 {count} 篇文章融合',
      processingLabel: 'AI 处理中',
      processingTitle: '文章簇仍在后台生成中',
      processingDescription: '后台 AI 正在继续完成摘要、聚类和融合。处理结束后，这里会自动切换为正常的文章簇列表。',
      processingViewDetails: '查看详情',
      processingBackToList: '返回列表',
      ...
      processingPending: '待完成',
      processingQueued: '队列中',
      processingBreakdownTitle: '待完成任务拆分',
      processingBreakdownDescription: '下面 4 项表示每篇未完成文章当前卡住的阶段，四项加总会等于“待完成”。',
      processingPendingSummary: '待生成摘要',
      processingPendingTranslation: '待生成翻译',
      processingPendingEmbedding: '待生成向量',
      processingPendingClustering: '待完成聚类',
      processingPendingRecommendationTask: '推荐补回',
      processingWorkers: '运行中任务',
      processingAdditionalRecommendation: '另外还有 {count} 个 AI 每日推荐补回任务，它不计入文章簇“待完成”总数。',
      processingRecentFailureTitle: '最近一次失败',
      processingRecentFailureStage: '失败阶段：{stage}',
      processingRecentFailureArticle: '文章：{title}',
      processingRecentFailureModel: '模型：{model}',
      processingRecentFailureEndpoint: '接口：{endpoint}',
      processingRecentFailureCount: '同类失败已连续出现 {count} 次。',
      processingRecentFailureView: '查看详情',
      processingRecentFailureClose: '关闭',
      processingRecentFailureMessage: '错误详情',
      processingUnknownFailureStage: '未知阶段',
      refreshRecommendations: '刷新推荐',
      selectPrompt: '选择一个文章簇以查看 AI 融合结果',
      sourceArticlesTitle: '来源文章',
      sourceLabel: 'AI 融合',
      statusLabel: '状态',
      summaryTitle: '摘要',
      unknownFeed: '未知订阅源',
  ...
  common: {
    ...
    action: {
      ...
      saveChanges: '保存更改',
      saving: '保存中...',
      setImageMode: '设置为图片模式',
      unsetImageMode: '取消图片模式',
      switchTo: '切换到',
      unsubscribe: '取消订阅',
      yes: '是',
    },
  ...
  modal: {
    ...
    feed: {
      ...
      clearArticles: '清空文章',
      clearArticlesConfirmMessage: '确定要清空此订阅源的所有文章吗？',
      clearArticlesConfirmTitle: '清空文章',
      articlesCleared: '已清空 {count} 篇文章',
      feedDiscovery: '订阅源发现',
      feedName: '订阅名称',
      ...
      imageModeSetSuccess: '已为选中的订阅源启用图片模式',
      imageModeUnsetSuccess: '已为选中的订阅源禁用图片模式',
      selectTagsToAdd: '选择要添加的标签：',
      setImageModeMessage: '为 {count} 个选中的订阅源启用图片模式？',
      setImageModeTitle: '设置图片模式',
      tagsAddedSuccess: '标签添加成功',
      unsetImageModeMessage: '为 {count} 个选中的订阅源禁用图片模式？',
      unsetImageModeTitle: '取消图片模式',
      manageFeeds: '管理订阅',
      noFeeds: '暂无订阅',
      proxy: '订阅代理',
    ...
    saved: '设置已保存',
    cancelled: '已放弃更改',
    unsavedChanges: '您有未保存的更改，确定要在关闭前保存吗？',
    update: {
      downloadUpdate: '下载更新',
  ...
  setting: {
    ...
    unsavedChanges: '您有未保存的更改，确定要在关闭前保存吗？',
    unsavedChangesTitle: '未保存的更改',
    unsavedChangesMessage: '您有未保存的更改，确定要在关闭前保存吗？',
    saveAndClose: '保存并关闭',
    ...
    ai: {
      ...
      processingLockedDescription:
        '后台 AI 处理尚未结束。AI 相关设置和嵌入模型配置会在文章簇处理完成后自动解冻。',
      aiFusionEnabled: 'AI 融合',
      aiFusionEnabledDesc: '启用后可对相关文章进行聚合与融合，并在聚合视图中展示结果',
      aiFusionDisabled: '请先配置基础 AI 能力（摘要、翻译、搜索、聊天、嵌入模型）后再开启 AI 融合',
      aiFusionRequiresProfile: '请先为 AI 融合选择有效的 AI 配置',
      aiRecommendationEnabled: 'AI 每日推荐',
      aiRecommendationEnabledDesc: '启用后可在侧边栏查看 AI 生成的每日推荐与历史推荐',
      aiRecommendationDisabled: '请先启用基础 AI 能力并开启 AI 融合后再开启 AI 每日推荐',
      aiRecommendationRequiresProfile: '请先为 AI 每日推荐选择有效的 AI 配置',
      selectRecommendationProfile: '推荐配置',
      selectRecommendationProfileDesc: '选择用于每日推荐生成与排序的 AI 配置',
      embeddingModels: '嵌入模型配置',
      addEmbeddingModel: '添加模型',
      editEmbeddingModel: '编辑模型',
      modelName: '模型名称',
      modelNamePlaceholder: '例如: BAAI/bge-m3',
      apiBaseUrl: 'API Base URL',
      apiBaseUrlPlaceholder: '例如: https://api.siliconflow.cn/v1',
      apiKey: 'API 密钥',
    ...
    customization: {
      ...
      scriptsFolderNotAvailable: '服务器模式下无法打开脚本文件夹，请直接在服务器上访问。',
    ...
    update: {
      ...
      notNow: '暂不更新',
      serverModeNoAutoUpdate: '服务器模式不支持自动更新，请手动更新。',
  ...
  auth: {
    userInfo: {
      ...
      username: '用户名',
      email: '邮箱',
      viewAccountInfo: '查看账号信息',
      readonlyHint: '此信息为只读，如需修改请联系管理员',
      inheritTemplate: '继承模板数据',
      inheritTemplateDesc: '从模板用户继承订阅源和设置数据',
      inheritTemplateConfirm: '确定要继承模板数据吗？这将导入模板用户的所有订阅源和设置。',
      inheritTemplateSuccess: '成功继承模板数据！',
      inheritTemplateAlready: '已继承模板数据',
      inheritTemplateLoading: '正在继承...',
    },
  },

  admin: {
    title: '用户管理',
    pendingRegistrations: '待审批注册',
    noPendingRegistrations: '暂无待审批注册',
    userList: '用户列表',
    noUsers: '暂无用户',
    editUser: '编辑用户',
    quota: '配额',
    ...
    cancel: '取消',
    templateUser: '模板用户',
    createTemplateUser: '创建模板用户',
    noTemplateUser: '尚未创建模板用户',
    templateUserInfo: '模板用户信息',
    maxFeeds: '最大订阅源数',
    maxArticles: '最大文章数',
    maxAITokens: '最大 AI Token 使用量',
    maxAIConcurrency: '最大 AI 并发数',
    maxFeedFetchConcurrency: '最大订阅源抓取并发数',
    maxDBQueryConcurrency: '最大数据库查询并发数',
    maxMediaCacheConcurrency: '最大媒体缓存下载并发数',
    maxRSSDiscoveryConcurrency: '最大 RSS 发现并发数',
    maxRSSPathCheckConcurrency: '最大 RSS 路径检查并发数',
    maxTranslationConcurrency: '最大翻译并发数',
    ...
    createTemplate: '创建模板用户',
    approveFailed: '批准失败',
    rejectFailed: '拒绝失败',
    saveFailed: '保存失败',
    deleteFailed: '删除失败',
    getQuotaFailed: '获取配额失败',
    saveQuotaFailed: '保存配额失败',
    createTemplateFailed: '创建模板用户失败',
    logout: '退出登录',
