...
const zh: TranslationMessages = {
  ...
  setting: {
    ...
    ai: {
      ...
      // AI 配置管理
      aiProfiles: 'AI 配置',
      aiProfilesDesc: '管理多个 AI 配置，用于不同的服务和提供商',
      addProfile: '添加配置',
      editProfile: '编辑配置',
      deleteProfile: '删除',
      ...
      noProfilesConfigured: '未配置 AI 配置。前往 AI 设置添加一个。',
      testProfile: '测试',
      testAllProfiles: '测试全部',
      testingAll: '测试中...',
      setAsDefault: '设为默认',
      setAsDefaultDesc: '当未为功能指定特定配置时，使用此配置',
      isDefault: '默认配置',
      default: '默认',
      defaultProfileSet: '默认配置已设置',
      selectProfile: 'AI 配置',
