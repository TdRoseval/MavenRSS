...
const en: TranslationMessages = {
  ...
  common: {
    ...
    errors: {
      ...
      fetchingTags: 'Error fetching tags',
  ...
  modal: {
    ...
    tag: {
      ...
      name: 'Tag Name',
      noTags: 'No tags yet',
      noTagsAvailable: 'No tags available. Please create tags first.',
  ...
  setting: {
    ...
    ai: {
      ...
      aiProfilesDesc: 'Manage multiple AI configurations for different services and providers',
      ...
      noProfilesConfigured: 'No AI profiles configured. Go to AI Settings to add one.',
      testProfile: 'Test',
      testAllProfiles: 'Test All',
      testingAll: 'Testing...',
      setAsDefault: 'Set as Default',
      setAsDefaultDesc: 'Use this profile when no specific profile is selected for a feature',
      isDefault: 'Default Profile',
      default: 'Default',
      defaultProfileSet: 'Default profile set successfully',
