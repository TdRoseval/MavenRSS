...
const en: TranslationMessages = {
  article: {
    ...
    cluster: {
      ...
      dailyRecommendationRefreshStarted: 'Daily recommendations refresh started',
      dailyRecommendationRefreshed: 'Daily recommendations refreshed',
      dailyRecommendationTaskAutomaticDescription:
        'The automatic daily recommendation job is running in the background. The list will update when the new top 10 is ready.',
      dailyRecommendationTaskCandidates: 'Candidates',
      dailyRecommendationTaskDate: 'Target date',
      dailyRecommendationTaskLabel: 'Recommendation Task',
      dailyRecommendationTaskManualDescription:
        'A manual refresh is rebuilding the daily recommendations with the latest interest vector.',
      dailyRecommendationTaskSaved: 'Saved',
      dailyRecommendationTaskScoring: 'Scoring',
      dailyRecommendationTaskSelected: 'Selected',
      dailyRecommendationTaskStage: 'Current stage',
      dailyRecommendationTaskStageFailed: 'Refresh failed',
      dailyRecommendationTaskStagePreparing: 'Preparing task',
      dailyRecommendationTaskStageQueued: 'Queued to start',
      dailyRecommendationTaskStageRanking: 'Ranking candidates',
      dailyRecommendationTaskStageRecalling: 'Recalling candidates',
      dailyRecommendationTaskStageSaving: 'Saving recommendations',
      dailyRecommendationTaskStageScoring: 'Scoring shortlisted items',
      dailyRecommendationTaskStageWaiting: 'Waiting for background work',
      dailyRecommendationTaskTitle: 'Daily recommendations are being rebuilt',
      dailyRecommendationTaskTrigger: 'Trigger',
      dailyRecommendationTaskTriggerAutomatic: 'Automatic',
      dailyRecommendationTaskTriggerManual: 'Manual refresh',
      dailyRecommendationTaskWaitingDescription:
        'The recommendation refresh has been queued and will start once background AI work becomes idle.',
      dailyRecommendationTaskWaitingHint:
        'Recommendation refresh is waiting for summary, translation, embedding, or clustering work to finish first.',
      ...
      processingBreakdownTitle: 'Pending task breakdown',
      processingBreakdownDescription:
        'These four buckets show the current blocking stage for each unfinished article, so their sum matches Pending.',
      processingPendingSummary: 'Summary pending',
      processingPendingTranslation: 'Translation pending',
      processingPendingEmbedding: 'Embedding pending',
      processingPendingClustering: 'Clustering pending',
      processingPendingRecommendationTask: 'Recommendation backfill',
      processingWorkers: 'Running tasks',
      processingAdditionalRecommendation:
        'There are also {count} AI daily recommendation backfill tasks, which are not counted in cluster Pending.',
      processingRecentFailureTitle: 'Most recent failure',
      processingRecentFailureStage: 'Stage: {stage}',
      processingRecentFailureArticle: 'Article: {title}',
      processingRecentFailureModel: 'Model: {model}',
      processingRecentFailureEndpoint: 'Endpoint: {endpoint}',
      processingRecentFailureCount: 'The same failure has repeated {count} times.',
      processingRecentFailureView: 'View details',
      processingRecentFailureClose: 'Close',
      processingRecentFailureMessage: 'Error details',
      processingUnknownFailureStage: 'Unknown stage',
  ...
  common: {
    ...
    action: {
      ...
      saving: 'Saving...',
      setImageMode: 'Set Image Mode',
      unsetImageMode: 'Unset Image Mode',
      switchTo: 'Switch to',
  ...
  modal: {
    ...
    feed: {
      ...
      imageModeSetSuccess: 'Image mode enabled for selected feeds',
      imageModeUnsetSuccess: 'Image mode disabled for selected feeds',
      selectTagsToAdd: 'Select tags to add:',
      setImageModeMessage: 'Enable image mode for {count} selected feed(s)?',
      setImageModeTitle: 'Set Image Mode',
      tagsAddedSuccess: 'Tags added successfully',
      unsetImageModeMessage: 'Disable image mode for {count} selected feed(s)?',
      unsetImageModeTitle: 'Unset Image Mode',
  ...
  setting: {
    ...
    ai: {
      ...
      processingLockedDescription:
        'Background AI processing is still running. AI-related settings and embedding model configuration will unlock automatically after clustering finishes.',
      ...
      addEmbeddingModel: 'Add Model',
      editEmbeddingModel: 'Edit Model',
      modelName: 'Model Name',
      modelNamePlaceholder: 'e.g. BAAI/bge-m3',
      apiBaseUrl: 'API Base URL',
      apiBaseUrlPlaceholder: 'e.g. https://api.siliconflow.cn/v1',
      apiKey: 'API Key',
  ...
  auth: {
    userInfo: {
      ...
      readonlyHint:
        'This information is read-only. Contact an administrator if you need to make changes.',
      inheritTemplate: 'Inherit Template Data',
      inheritTemplateDesc: 'Inherit feeds and settings from template user',
      inheritTemplateConfirm:
        'Are you sure you want to inherit template data? This will import all feeds and settings from the template user.',
      inheritTemplateSuccess: 'Successfully inherited template data!',
      inheritTemplateAlready: 'Template data already inherited',
      inheritTemplateLoading: 'Inheriting...',
    },
  },
  ...
  admin: {
    ...
    maxAITokens: 'Max AI Token Usage',
    maxAIConcurrency: 'Max AI Concurrency',
    maxFeedFetchConcurrency: 'Max Feed Fetch Concurrency',
    maxDBQueryConcurrency: 'Max DB Query Concurrency',
    maxMediaCacheConcurrency: 'Max Media Cache Download Concurrency',
    maxRSSDiscoveryConcurrency: 'Max RSS Discovery Concurrency',
    maxRSSPathCheckConcurrency: 'Max RSS Path Check Concurrency',
    maxTranslationConcurrency: 'Max Translation Concurrency',
